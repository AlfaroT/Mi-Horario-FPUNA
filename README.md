...
<details>2. Ve a: [https://alfarot.github.io/Mi-Horario-FPUNA/](https://alfarot.github.io/Mi-Horario-FPUNA/)- **Local Storage**: Persistencia de datos local
...
2. Toca el menú **⋮** (esquina superior derecha)4. Desplázate hacia abajo y toca **"Agregar a pantalla de inicio"**## 🛠️ Instalación y Uso

3. Selecciona **"Agregar a pantalla de inicio"** o **"Instalar aplicación"**

4. Confirma con **"Agregar"**5. Dale un nombre y toca **"Agregar"**

5. ✅ ¡Listo! Ícono en tu pantalla principal
...
<summary><b>🍎 iOS (Safari)</b></summary>#### **💻 En PC (Chrome/Edge):**```bash



1. Abre la app en **Safari** (⚠️ debe ser Safari, no Chrome)# Instalar dependencias

2. Toca el botón **Compartir** 📤 (parte inferior)

3. Desplázate y selecciona **"Agregar a pantalla de inicio"**1. Abre la página en **Chrome** o **Edge**npm install

4. Dale un nombre y toca **"Agregar"**

5. ✅ ¡Listo! Ícono en tu Home Screen2. Busca el ícono de **"Instalar"** (⊕) en la barra de direcciones



</details>3. Haz clic en **"Instalar"**# Construir CSS



<details>4. ¡Listo! Se abrirá como una app de escritorio 🎉npm run build

<summary><b>💻 PC (Chrome/Edge)</b></summary>



1. Abre la app en **Chrome** o **Edge**

2. Busca el ícono **⊕ Instalar** en la barra de direcciones---# Iniciar servidor de desarrollo

3. Haz clic en **"Instalar"**

4. ✅ ¡Listo! Se abrirá como app de escritorionpm run serve



</details>## 📖 ¿Cómo usar la app?
